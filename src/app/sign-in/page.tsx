    ...
    <main className="mx-auto flex min-h-[70vh] max-w-2xl flex-col items-center justify-center px-5 py-20 rise">
      <div className="w-full max-w-sm text-center">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-full bg-ink px-4 py-3 text-sm font-medium text-paper transition-colors hover:bg-ink-soft"
        >
